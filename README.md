...
- 🌍 **12 languages** — Spanish is the default from the first login screen, and profiles can switch at any time (EN, DE, ES, FR, IT, PT, PL, TR, RU, ZH, KO, HI); Private Social is translated in Spanish and uses English fallback strings elsewhere; exercise instructions are localized in 10 languages
