...
export default function Library() {
  ...
  return <>
    ...
    <div className="search" style={{ marginBottom: 10 }}><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7" /><path d="m21 21-4.3-4.3" /></svg>
      <input className="input" placeholder={t('Search…')} aria-label={t('Search…')} value={q} onChange={e => { setQ(e.target.value); setShown(40) }} /></div>
    ...
    <div className="list">
      ...
      {f.slice(0, shown).map(e => {
        ...
        return <div key={e.id} className="item">
          <button type="button" className="item-tap" onClick={() => exerciseDetailSheet(e)}>
            <Thumb ex={e} />
