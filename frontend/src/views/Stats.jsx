...
import { lastBW, planStreak, setLabel, modeOf, effortOf } from '../lib/history.js'
...
import SocialStats from '../components/SocialStats.jsx'
...
export default function Stats() {
  ...
  return <>
    ...
    <div className="tiles">
      ...
      <div className="tile"><div className="l"><Icon name="flame" />{t('Plan streak')}</div><div className="v">{planStreak(S)}</div></div>
