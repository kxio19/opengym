...
const P = {
  ...
  message: <><path d="M4.4 6.4a2 2 0 0 1 2-2h11.2a2 2 0 0 1 2 2v8.4a2 2 0 0 1-2 2H9.8l-4 3.4v-3.4H6.4a2 2 0 0 1-2-2Z" /></>,
  camera: <><path d="M4.6 8.4a1.8 1.8 0 0 1 1.8-1.8h1.4l1-2h6.4l1 2h1.4a1.8 1.8 0 0 1 1.8 1.8v9a1.8 1.8 0 0 1-1.8 1.8H6.4a1.8 1.8 0 0 1-1.8-1.8Z" /><circle cx="12" cy="13" r="3.6" /></>,
}
